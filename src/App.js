    ...
    <>
      <Box className="App">
        <Box
          ...
          className={isSidebarOpen ? "sidebar sidbar-open " : "sidebar close"}
        >
          ...
          <Box className="one main-content !overflow-x-hidden">
            <Box>
              <Routes>
                ...
                <Route path="/five-star-rating" element={<FiveStarRating />} />
                <Route path="/add-products" element={<AddEcommerceData />} />
